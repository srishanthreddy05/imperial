...
import { Bot, Phone, X, MessageSquareText, Smartphone } from 'lucide-react';
    ...
    <>
      ...
      <div ref={wrapperRef} className="fixed bottom-6 right-6 z-50 font-sans flex flex-col items-end gap-3">
        ...
        <a
          ...
          className="flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white text-gray-800 shadow-lg transition-all duration-300 border-l-4 border-l-cyan-500 hover:translate-x-[-8px] hover:scale-[1.02] hover:shadow-xl active:scale-[0.98]"
          aria-label="Call now"
          title="Call now"
        >
        ...
        {/* Chat Button (Triggers Popover) */}
        <button
          onClick={() => setChatMenuOpen(!chatMenuOpen)}
          className="flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white text-gray-800 shadow-lg transition-all duration-300 border-l-4 border-l-[#005EB8] hover:translate-x-[-8px] hover:scale-[1.02] hover:shadow-xl active:scale-[0.98] cursor-pointer"
